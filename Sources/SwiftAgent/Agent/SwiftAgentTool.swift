...
/// }
/// ```
public protocol SwiftAgentTool: FoundationModels.Tool, Encodable, Equatable where Arguments: Generable & Equatable, Arguments.PartiallyGenerated: Equatable, Output: Generable & Equatable {}
