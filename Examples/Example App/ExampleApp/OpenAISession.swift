...
//
//class Test {
//	var _myProperty: Bool = false
//	var myProperty: Bool {
//		@storageRestrictions(initializes: _myProperty)
//		init(initialValue) {
//			_myProperty = initialValue
//		}
//		get {
//			access(keyPath: \.myProperty)
//			return _myProperty
//		}
//		set {
//			guard shouldNotifyObservers(_myProperty, newValue) else {
//				_myProperty = newValue
//				return
//			}
//
//			withMutation(keyPath: \.myProperty) {
//				_myProperty = newValue
//			}
//		}
//		_modify {
//			access(keyPath: \.myProperty)
//			_$observationRegistrar.willSet(self, keyPath: \.myProperty)
//			defer {
//				_$observationRegistrar.didSet(self, keyPath: \.myProperty)
//			}
//			yield &_myProperty
//		}
//	}
...
//extension Test: nonisolated Observation.Observable {}
