...
//   private func performStructuredResponse() async throws -> ExampleSession.Response<WeatherForecast> {
...
//     _ agentResponse: ExampleSession.Response<WeatherForecast>,
//   ) {
...
//       #expect(decodedForecast == agentResponse.content)
//     } catch {
...
//       Issue.record("Expected a single recorded request")
//       return
//     }
...
//     guard let textConfiguration = request.body.text else {
//       Issue.record("Expected text configuration for structured output request")
//       return
//     }
//     guard let format = textConfiguration.format else {
//       Issue.record("Expected text configuration format to be present")
//       return
//     }
//     guard case let .jsonSchema(config) = format else {
//       Issue.record("Expected text configuration format to be .jsonSchema")
//       return
//     }
...
//           "annotations": [],
//           "logprobs": [],
//           "text": "{\"temperature_celsius\":22,\"condition\":\"Partly Cloudy\"}"
//         }
//       ],
//       "role": "assistant"
//     }
